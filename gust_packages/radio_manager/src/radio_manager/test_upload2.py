...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 23 15:15:47 2022
...
def uploadmission(aFileName):
    home_location = None
    home_altitude = None
    print("reading and preparing the text file")
    ...
    print("home_location:: {}".format(home_location))
...
print('{}/mission.txt'.format(current))
uploadmission('{}/mission.txt'.format(current))