...
"font: 12pt \"Umpush\";")
        ...
        self.pushButton_actions = QtWidgets.QPushButton(self.gridlayout_functions)
        self.pushButton_actions.setStyleSheet("background-color: rgb(48,132,70);\n"
"color: rgb(255, 255, 255);\n"
"font: 12pt \"Umpush\";")
        self.pushButton_actions.setObjectName("pushButton_actions")
        self.gridLayout_3.addWidget(self.pushButton_actions, 1, 1, 1, 1)
...
"font: 14pt \"Umpush\";")
        ...
        self.pushButton_sitl = QtWidgets.QPushButton(self.widget_main)
        self.pushButton_sitl.setMinimumSize(QtCore.QSize(150, 0))
        self.pushButton_sitl.setMaximumSize(QtCore.QSize(16777215, 30))
        self.pushButton_sitl.setStyleSheet("background-color: rgb(48,132,70);\n"
"color: rgb(255, 255, 255);\n"
"font: 14pt \"Umpush\";")
        self.pushButton_sitl.setObjectName("pushButton_sitl")
        self.horizontalLayout.addWidget(self.pushButton_sitl)
    ...
    def retranslateUi(self, MainWindow_main):
        ...
        self.pushButton_actions.setText(_translate("MainWindow_main", "Actions"))
        ...
        self.pushButton_sitl.setText(_translate("MainWindow_main", "SITL"))
