...
# Form implementation generated from reading ui file '/workspaces/gust/src/main/python/gust/gui/ui/gustClient.ui'
#
...
"font: 75 20pt \"URW Bookman L\";")
        ...
        self.label_vehicle_type = QtWidgets.QLabel(self.verticalWidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_vehicle_type.setFont(font)
        self.label_vehicle_type.setAlignment(QtCore.Qt.AlignCenter)
        self.label_vehicle_type.setObjectName("label_vehicle_type")
        self.verticalLayout.addWidget(self.label_vehicle_type)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_ekf = QtWidgets.QLabel(self.verticalWidget)
        font = QtGui.QFont()
...
"font: 75 20pt \"Padauk Book [PYRS]\";")
        ...
        self.line_7 = QtWidgets.QFrame(self.widget_main)
...
"font: 14pt \"Umpush\";")
        ...
        self.comboBox_saved_locations.setMaximumSize(QtCore.QSize(16777215, 25))
        self.comboBox_saved_locations.setObjectName("comboBox_saved_locations")
        self.horizontalLayout.addWidget(self.comboBox_saved_locations)
        self.pushButton_refresh_map = QtWidgets.QPushButton(self.widget_main)
        self.pushButton_refresh_map.setMinimumSize(QtCore.QSize(90, 25))
        self.pushButton_refresh_map.setMaximumSize(QtCore.QSize(16777215, 25))
        self.pushButton_refresh_map.setObjectName("pushButton_refresh_map")
        self.horizontalLayout.addWidget(self.pushButton_refresh_map)
    ...
    def retranslateUi(self, MainWindow_main):
        ...
        self.label_status.setText(_translate("MainWindow_main", "SYSTEM STATUS"))
        ...
        self.label_heading.setText(_translate("MainWindow_main", "Heading"))
        ...
        self.pushButton_commands.setText(_translate("MainWindow_main", "Commands"))
