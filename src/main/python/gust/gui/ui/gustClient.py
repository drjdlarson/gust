...
"font: 14pt \"Umpush\";")
        ...
        self.pushButton_refresh_map.setMinimumSize(QtCore.QSize(150, 0))
        self.pushButton_refresh_map.setMaximumSize(QtCore.QSize(16777215, 30))
    ...
    def retranslateUi(self, MainWindow_main):
        ...
        self.pushButton_refresh_map.setText(_translate("MainWindow_main", "Refresh map"))
