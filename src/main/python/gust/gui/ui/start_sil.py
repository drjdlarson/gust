...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_home_lat)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_home_lat)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_home_lon)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_home_lon)
        self.label_framerate = QtWidgets.QLabel(Dialog)
        self.label_framerate.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_framerate.setFont(font)
        self.label_framerate.setObjectName("label_framerate")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_framerate)
        self.lineEdit_framerate = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_framerate.setEnabled(False)
        self.lineEdit_framerate.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lineEdit_framerate.setObjectName("lineEdit_framerate")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.lineEdit_framerate)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_start_heading)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit_start_heading)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_start_altitude)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.lineEdit_start_altitude)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_select_home)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBox_select_home)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_framerate.setText(_translate("Dialog", "SIL Framerate"))
